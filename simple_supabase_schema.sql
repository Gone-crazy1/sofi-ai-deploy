...
CREATE INDEX idx_virtual_accounts_whatsapp_number ON virtual_accounts(whatsapp_number);
...
INSERT INTO users (whatsapp_number, phone_number, full_name, email, balance) 
